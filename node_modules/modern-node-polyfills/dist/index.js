...
// node_modules/.pnpm/resolve.exports@1.1.1/node_modules/resolve.exports/dist/index.mjs
...
function bail(name, entry, condition) {
  throw new Error(
    condition ? `No known conditions for "${entry}" entry in "${name}" package` : `Missing "${entry}" export in "${name}" package`
  );
}
  ...
  if (exports) {
    ...
    if (target !== ".") {
      ...
      if (k && kv) {
        ...
        return tmp.includes("*") ? tmp.replace(/[*]/g, kv) : tmp + kv;
      }
    }
    return bail(name, target);
  }
